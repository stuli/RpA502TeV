...
void GetErrorFromData() {
  ...
  for (int ipt = -1; ipt<numtot; ipt++) {
    ...
    TString binLabel = strbinLow+"<"+binvar+"<"+strbinHigh;
    ...
    PANomFileName = Form("../../../JaredNomFits/nomfitresults_upsilon_%s.root",kineLabel.Data());
    theFile = TFile::Open(PANomFileName,"READ");
	workspace = (RooWorkspace*)theFile->Get("workspace");
	...
	if (ptLow > 5.0 || (ptLow == 4.0 && ptHigh == 9.0))
		PAAltFileName = Form("ResultsBkg/powfitresults_upsilon_%s.root",kineLabel.Data());
	else
		PAAltFileName = Form("ResultsBkg/altfitresults_upsilon_%s.root",kineLabel.Data());
    ...
    PPNomFileName = Form("../../../JaredNomFits/nomfitresults_upsilon_%s.root",kineLabel.Data());
	...
	if (ptLow > 5.0 || (ptLow == 4.0 && ptHigh == 9.0))
		PPAltFileName = Form("ResultsBkg/powfitresults_upsilon_%s.root",kineLabel.Data());
	else
		PPAltFileName = Form("ResultsBkg/altfitresults_upsilon_%s.root",kineLabel.Data());
    ...
    float NthisSPPAlt;
	if (whichUpsilon==1) {
      NthisSPANom = N1SPANom;
      NthisSPAAlt = N1SPAAlt;
      NthisSPPNom = N1SPPNom;
      NthisSPPAlt = N1SPPAlt;
    }
    else if (whichUpsilon==2) {
      NthisSPANom = N2SPANom;
      NthisSPAAlt = N2SPAAlt;
      NthisSPPNom = N2SPPNom;
      NthisSPPAlt = N2SPPAlt;
    }
    else if (whichUpsilon==3) {
      NthisSPANom = N3SPANom;
      NthisSPAAlt = N3SPAAlt;
      NthisSPPNom = N3SPPNom;
      NthisSPPAlt = N3SPPAlt;
    }
    /*if (whichUpsilon==1) {
    ...
    cout << setw(Width1S) << setfill(separator) << Form("%.2f",TMath::Abs(PPthisSerr));
    cout << setw(Width1S) << setfill(separator) << Form("%.2f",TMath::Abs(PAthisSerr));
    cout << setw(Width1S) << setfill(separator) << Form("%.2f",TMath::Abs(RpAerr));
    /*if (whichUpsilon>1) {
