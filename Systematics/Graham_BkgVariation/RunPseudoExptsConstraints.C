...
#include "FitDataWithConstraintsAltBkg.C"
...
void RunPseudoExptsConstraints(
		int collId = 1,
			...
			)
{
	...
	for (int i = 0; i < numTrials; i++)
	{
		...
		FitDataWithConstraintsAltBkg(collId,ptLow,ptHigh,yLow,yHigh,cLow,cHigh,muPtCut,whichModel,resultVector,pseudoData,NomFileName);
		...
		FitDataWithConstraintsAltBkg(collId,ptLow,ptHigh,yLow,yHigh,cLow,cHigh,muPtCut,0,resultVector,pseudoData,NomFileName);
