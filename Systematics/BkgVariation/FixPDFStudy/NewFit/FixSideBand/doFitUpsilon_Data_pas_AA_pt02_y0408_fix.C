...
void doFitUpsilon_Data_pas_AA_pt02_y0408_fix(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 1.672 , 1.293, 3.031);
  ...
  RooRealVar n1s_1("n1s_1","power order", 1.904 , 1.561, 3.402);
  ...
  TFile *fileIn_parm = new TFile(Form("../BkgFit/BkgFit_fitresults_upsilon_DoubleCB_%s.root",kineLabel.Data()),"read");
  ...
  TFile* outf = new TFile(Form("Data_fitresults_upsilon_DoubleCB_%s.root",kineLabel.Data()),"recreate");
  outh->Write();
  c1->SaveAs(Form("Data_fitresults_upsilon_DoubleCB_%s.pdf",kineLabel.Data()));
  c1->SaveAs(Form("Data_fitresults_upsilon_DoubleCB_%s.png",kineLabel.Data()));
  c1->Write();
  ws->Write();
