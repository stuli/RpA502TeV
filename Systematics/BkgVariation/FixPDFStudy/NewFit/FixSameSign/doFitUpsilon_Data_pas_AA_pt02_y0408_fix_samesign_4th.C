...
void doFitUpsilon_Data_pas_AA_pt02_y0408_fix_samesign_4th(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  TFile *fileIn_parm = new TFile(Form("../../BkgFit/SameSignFit/BkgFit_4th_SameSign_fitresults_upsilon_DoubleCB_%s.root",kineLabel.Data()),"read");
  ...
  TFile* outf = new TFile(Form("Data_SameSign_4th_fitresults_upsilon_DoubleCB_%s.root",kineLabel.Data()),"recreate");
  outh->Write();
  c1->SaveAs(Form("Data_SameSign_4th_fitresults_upsilon_DoubleCB_%s.pdf",kineLabel.Data()));
  c1->SaveAs(Form("Data_SameSign_4th_fitresults_upsilon_DoubleCB_%s.png",kineLabel.Data()));
  c1->Write();
  ws->Write();
