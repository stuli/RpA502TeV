...
do
    ...
    do
	    for rap in '0.8,1.2'
	    #for rap in '0,0.4' '0.4,0.8' '0.8,1.2' '1.2,1.6' '1.6,2.0' '2.0,2.4' '0,1.2' '1.2,2.4' '0,0.8' '0.8,1.6' '1.6,2.4'
        do
          echo  $outputDir 'doSys_BkgVar_linear.C('$i','$pt','$rap',0,200,'$muPtCut','$fixParam')'
            ./condor_root.sh $outputDir 'doSys_BkgVar_linear.C('$i','$pt','$rap',0,200,'$muPtCut','$fixParam')'
        done
    done
    for pt in '4,6' 
    #for pt in '0,30' '0,2' '2,4' '4,6' '6,9' '9,12' '12,30' '0,4' '4,9' '9,30' '0,6' '6,30'
    do
	    for rap in '0,2.4'
        do
          echo  $outputDir 'doSys_BkgVar_linear.C('$i','$pt','$rap',0,200,'$muPtCut','$fixParam')'
...
do
    for cent in '10,20' '20,40'
    #for cent in '0,10' '10,20' '20,40' '40,60' '0,60'
    do
	      for rap in '0,2.4'
        do
          echo  $outputDir 'doSys_BkgVar_linear.C('$i',0,30,'$rap','$cent','$muPtCut','$fixParam')'
 #         ./condor_root.sh $outputDir 'doSys_BkgVar_linear.C('$i',0,30,'$rap','$cent','$muPtCut','$fixParam')'
	      done
      done
    ...
    do
      for rap in '0,2.4'
      do
        echo  $outputDir 'doSys_BkgVar_linear.C(6,0,30,'$rap','$cent1','$muPtCut','$fixParam')'
	 #   ./condor_root.sh $outputDir 'doSys_BkgVar_linear.C(6,0,30,'$rap','$cent1','$muPtCut','$fixParam')'
	    done
    done
