...
//for pt bin
if ( binMatched( 4, 0, 30, 0, 2.4, 0, 200) )   { setSignalParMC( 2.84517, 1.36894, 0.0684228, 9.45737, 0.602446, 1.85621 );}
if ( binMatched( 4, 0, 2.5, 0, 2.4, 0, 200) )   { setSignalParMC( 2.51572, 1.36038, 0.0660054, 9.45828, 0.575459, 1.94671 );}
if ( binMatched( 4, 2.5, 5, 0, 2.4, 0, 200) ) { setSignalParMC( 2.63763, 1.42659, 0.0689422, 9.45728, 0.604498, 1.80244 );}
if ( binMatched( 4, 5, 8, 0, 2.4, 0, 200) ) { setSignalParMC( 3.93342, 1.32698, 0.0680923, 9.45797, 0.611182, 1.87937 );}
if ( binMatched( 4, 8, 15, 0, 2.4, 0, 200) ) { setSignalParMC( 2.75442, 1.31236, 0.0681348, 9.45692, 0.605204, 1.85662 );}
if ( binMatched( 4, 15, 30, 0, 2.4, 0, 200) ) { setSignalParMC( 2.63653, 1.46321, 0.0735693, 9.45612, 0.645267, 1.80864 );}
if ( binMatched( 4, 0, 5, 0, 2.4, 0, 200) ) { setSignalParMC( 2.47191, 1.40481, 0.0673622, 9.45771, 0.584689, 1.86278 );}
if ( binMatched( 4, 5, 15, 0, 2.4, 0, 200) ) { setSignalParMC( 3.15578, 1.3226, 0.0681048, 9.45737, 0.607122, 1.86533 );}

if ( binMatched( 4, 0, 30, 0, 0.4, 0, 200) )   { setSignalParMC( 3.05697, 1.06017, 0.0754069, 9.45866, 0.326219, 0.715251 );}
if ( binMatched( 4, 0, 30, 0.4, 0.8, 0, 200) ) { setSignalParMC( 1.27276, 1.84114, 0.0648444, 9.4588, 0.694488, 1.46609 );}
if ( binMatched( 4, 0, 30, 0.8, 1.2, 0, 200) )   { setSignalParMC( 1.90975, 1.5204, 0.0761292, 9.45537, 0.471149, 1.42498 );}
if ( binMatched( 4, 0, 30, 1.2, 1.6, 0, 200) )   { setSignalParMC( 6.01133, 1.00139, 0.0839045, 9.45273, 0.297959, 1.44207 );}
if ( binMatched( 4, 0, 30, 1.6, 2, 0, 200) ) { setSignalParMC( 6.01654, 1.63034, 0.122955, 9.45, 0.734874, 1.34836 );}
if ( binMatched( 4, 0, 30, 2, 2.4, 0, 200) )   { setSignalParMC( 1.00114, 1.00121, 0.0677261, 9.44797, 0.11848, 2.49903 );}
if ( binMatched( 4, 0, 30, 0, 1.2, 0, 200) )   { setSignalParMC( 5.96691, 1.39766, 0.0877459, 9.45737, 0.664216, 0.602696 );}
if ( binMatched( 4, 0, 30, 1.2, 2.4, 0, 200) ) { setSignalParMC( 1.0824, 1.00126, 0.0534197, 9.45014, 0.108649, 2.46433 );}
