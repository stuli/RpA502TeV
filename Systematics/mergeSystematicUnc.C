...
void mergeSystematicUnc(int state = 1) { 
  ...
  TFile* f1_pp = new TFile(Form("../Efficiency/RootFiles/EffCor_SysPPXS_%dS.root",state) );
  ...
  hptPP[1] = (TH1D*) f1_pp->Get("EffSysPt");
  hptPA[1] = (TH1D*) f1_1_2->Get("EffSysPt");
  hptPAdw[1] = (TH1D*) f1_1->Get("EffSysPt");
  hrapPP[1] = (TH1D*) f1_pp->Get("EffSysRap");
  ...
  */
  ...
  hrapPP1[2] = (TH1D*)f2->Get(Form("hrapSysAccPPPt1_%dS",state));
  hrapPP2[2] = (TH1D*)f2->Get(Form("hrapSysAccPPPt2_%dS",state));
  hrapPA1[2] = (TH1D*)f2->Get(Form("hrapSysAccPAPt1_%dS",state));
  hrapPA2[2] = (TH1D*)f2->Get(Form("hrapSysAccPAPt2_%dS",state));
  ...
  hrapRPA1[2] = (TH1D*)f2->Get(Form("hrapSysAccPPPt1_%dS",state)); hrapRPA1[2]->Reset();// (TH1D*)hrapPA[1]->Clone("hrapRPA_1");   hrapRPA[1]->Reset();
  hrapRPA2[2] = (TH1D*)f2->Get(Form("hrapSysAccPPPt2_%dS",state)); hrapRPA2[2]->Reset();// (TH1D*)hrapPA[1]->Clone("hrapRPA_1");   hrapRPA[1]->Reset();
  ...
  hrapPP[2] = (TH1D*) f2->Get(Form("hrapSysAccPP_%dS",state));
  ...
  hptPP1[3] = (TH1D*)f3->Get("hptSysSigPP");
  hptPP2[3] = (TH1D*)f3->Get("hptSysSigPP"); 
  hptPA1[3] = (TH1D*)f3->Get("hptSysSigPA");
  hptPA2[3] = (TH1D*)f3->Get("hptSysSigPA"); 
  ...
  hrapPA2[3] = (TH1D*)f3->Get("hySysSigPAHighPt_in3Sbins"); 
  ...
  hptRPA1[3] = (TH1D*)f3->Get("hptSysSigRpA"); //  (TH1D*)hptPA[1]->Clone("hptRPA_1");   hptRPA[1]->Reset();
  hptRPA2[3] = (TH1D*)f3->Get("hptSysSigRpA"); //  (TH1D*)hptPA[1]->Clone("hptRPA_1");   hptRPA[1]->Reset();
  ...
  hptPP1[4] = (TH1D*)f4->Get("hptSysSigPP");
  hptPP2[4] = (TH1D*)f4->Get("hptSysSigPP"); 
  hptPA1[4] = (TH1D*)f4->Get("hptSysSigPA");
  hptPA2[4] = (TH1D*)f4->Get("hptSysSigPA"); 
  ...
  hptRPA1[4] = (TH1D*)f4->Get("hptSysSigRpA"); //  (TH1D*)hptPA[1]->Clone("hptRPA_1");   hptRPA[1]->Reset();
  hptRPA2[4] = (TH1D*)f4->Get("hptSysSigRpA"); //  (TH1D*)hptPA[1]->Clone("hptRPA_1");   hptRPA[1]->Reset();
  ...
  mergeFiveInQuad_pp( hrapPP[0], hrapPP[1], hrapPP[2], hrapPP[3], hrapPP[4],hrapPP[5], state);
