...
using namespace std;
void GetDataDeviations_HFNtracks(int whichUpsilon=1,int binmode=0) {
//0=hfmode, 1=ntmode
  ...
  TString outFileName = Form("ErrorEstimates/DataDev%is",whichUpsilon);
  ...
  for (int iy = 0; iy<numybins/2; iy++) {
    ...
    TString NomFileNameF = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/NominalFits_2018_03_20/nomfitresults_upsilon_%s.root",kineLabelF.Data());
    ...
    TString NomFileNameB = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/NominalFits_2018_03_20/nomfitresults_upsilon_%s.root",kineLabelB.Data());
    ...
    TString AltFileNameF = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/AlternateFitsWithNominalSeeds/altfitresults_upsilon_%s.root",AltkineLabelF.Data());
    ...
    TString AltFileNameB = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/AlternateFitsWithNominalSeeds/altfitresults_upsilon_%s.root",AltkineLabelB.Data());
