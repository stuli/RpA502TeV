...
//    BIN        PP 2S ERR   PA 2S ERR     RpA ERR  PP R21 ERR  PA R21 ERR      DR ERR
 ntuple2spt->Fill(0.00,30.00,    0.164459,    0.836124,     2.75101,    -0.28856,      2.3321,     2.62824);
  ntuple2spt->Fill(0.00,4.00, 0.000872972,   -0.567326,    -2.40361,    0.216678,     -3.3027,    -3.51177);
  ntuple2spt->Fill(4.00,9.00,   0.185233,    0.135333,  -0.0657878,   0.0994367,    0.236349,    0.136779);
 ntuple2spt->Fill(9.00,30.00,      1.2503,   -0.323077,    -4.53606,     6.73083,    -2.48544,    -8.63506);
ntuple2sy->Fill(-1.93,0.80,   -0.425009,    0.217945,     2.18769,    -3.18302,    0.230041,     3.52527);
 ntuple2sy->Fill(-0.80,0.00,   -0.268228,   -0.120216,     0.36394,    -0.36434,    -1.88021,    -1.52141);
  ntuple2sy->Fill(0.00,0.80,   -0.268228,  -0.0246246,    0.714451,    -0.36434,  -0.0826176,    0.282749);
  ntuple2sy->Fill(0.80,1.93,   -0.425009,  -0.0409361,     1.23972,    -3.18302,    -0.23134,     3.04872);
...
//    BIN        PP 3S ERR   PA 3S ERR     RpA ERR  PP R31 ERR  PA R31 ERR      DR ERR
 ntuple3spt->Fill(0.00,30.00,   -0.317598,    0.455283,     6.11268,    -2.39676,     3.44567,     5.98589);
  ntuple3spt->Fill(0.00,6.00,    0.292526,   -0.912671,    -12.2086,     3.31599,    -11.3878,    -14.2319);
 ntuple3spt->Fill(6.00,30.00,  -0.0462051,  0.00173734,    0.248294,   -0.463168,    0.010551,    0.475928);
 ntuple3sy->Fill(-1.93,0.00,   -0.317598, -0.00406474,     1.64043,    -2.39676,  -0.0374606,     2.41723);
  ntuple3sy->Fill(0.00,1.93,   -0.317598,    0.173284,     3.03138,    -2.39676,     1.43605,     3.92692);
