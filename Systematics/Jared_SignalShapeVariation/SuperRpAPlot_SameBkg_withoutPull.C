...
void SuperRpAPlot_SameBkg_withoutPull( 
       int collId = kPADATA,  
...
//*****************************************************************************
  ...
  PPws->pdf("PPmodel")->plotOn(RpAmyPlot2,Name("PPmodelHistRpA"),LineColor(kOrange+7),LineWidth(2),LineStyle(2),Normalization(PPNorm,RooAbsReal::NumEvent));
  ...
  RpAfitleg->AddEntry(RpAmyPlot2->findObject("PPmodelHistRpA"),"RpA scaled","l");
  RpAfitleg->Draw("same");
