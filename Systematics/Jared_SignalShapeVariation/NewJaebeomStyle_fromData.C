...
using namespace std;
void NewJaebeomStyle_fromData(int whichUpsilon=1) {
  
  TString filename = Form("ErrorEstimates/DataDev%is.root",whichUpsilon);
  TString filename2 = Form("ErrorEstimates/DataDev%is_pt0to6to30.root",whichUpsilon);
  TString filename3 = Form("ErrorEstimates/DataDev%is_y193to000to193.root",whichUpsilon);
  TString filename4 = Form("ErrorEstimates/DataDev%is_hfbins.root",whichUpsilon);
  TString filename5 = Form("ErrorEstimates/DataDev%is_ntracksbins.root",whichUpsilon);
  TString filename6 = Form("ErrorEstimates/DataDev%isXSBins.root",whichUpsilon);
  TString outfilename = Form("ErrorEstimates/SysSig%is_fromData.root",whichUpsilon);
  ...
  for (int ipt = 1; ipt<numptbins*2+1; ipt++) {
    ...
    if (ipt<numptbins+1) {
      ...
      cout << "Forward " << ipt-numptbins << endl;
