...
void PlotFittedParams_HF(int whichUpsilon=1, int j=0) {
  ...
  //declare histograms
  TH1F* halphapt = new TH1F("halphapt","alpha vs hf",numhfbins,hfbins);
  TH1F* hf1spt = new TH1F("hf1spt","f1s vs hf",numhfbins,hfbins);
  TH1F* hmasspt = new TH1F("hmasspt","mass vs hf",numhfbins,hfbins);
  TH1F* hn1spt = new TH1F("hn1spt","n1s vs hf",numhfbins,hfbins);
  TH1F* hsigma1spt = new TH1F("hsigma1spt","sigma vs hf",numhfbins,hfbins);
  TH1F* hx1spt = new TH1F("hx1spt","x1s vs hf",numhfbins,hfbins);
  TH1F* herrmupt = new TH1F("herrmupt","errmu vs hf",numhfbins,hfbins);
  TH1F* herrsigmapt = new TH1F("herrsigmapt","errsigma vs hf",numhfbins,hfbins);
  TH1F* hlambdapt = new TH1F("hlambdapt","errlambda vs hf",numhfbins,hfbins);
  TH1F* hnSig1spt = new TH1F("hnSig1spt","nSig1s vs hf",numhfbins,hfbins);
  TH1F* hnSig2spt = new TH1F("hnSig2spt","nSig2s vs hf",numhfbins,hfbins);
  TH1F* hnSig3spt = new TH1F("hnSig3spt","nSig3s vs hf",numhfbins,hfbins);
  TH1F* hnBkgpt = new TH1F("hnBkgpt","nBkg vs hf",numhfbins,hfbins);

  TH1F* halphay = new TH1F("halphay","alpha vs hf",numhfbins,hfbins);
  TH1F* hf1sy = new TH1F("hf1sy","f1s vs hf",numhfbins,hfbins);
  TH1F* hmassy = new TH1F("hmassy","mass vs hf",numhfbins,hfbins);
  TH1F* hn1sy = new TH1F("hn1sy","n1s vs hf",numhfbins,hfbins);
  TH1F* hsigma1sy = new TH1F("hsigma1sy","sigma vs hf",numhfbins,hfbins);
  TH1F* hx1sy = new TH1F("hx1sy","x1s vs hf",numhfbins,hfbins);
  TH1F* herrmuy = new TH1F("herrmuy","errmu vs hf",numhfbins,hfbins);
  TH1F* herrsigmay = new TH1F("herrsigmay","errsigma vs hf",numhfbins,hfbins);
  TH1F* hlambday = new TH1F("hlambday","errlambda vs hf",numhfbins,hfbins);
  TH1F* hnSig1sy = new TH1F("hnSig1sy","nSig1s vs hf",numhfbins,hfbins);
  TH1F* hnSig2sy = new TH1F("hnSig2sy","nSig2s vs hf",numhfbins,hfbins);
  TH1F* hnSig3sy = new TH1F("hnSig3sy","nSig3s vs hf",numhfbins,hfbins);
  TH1F* hnBkgy = new TH1F("hnBkgy","nBkg vs hf",numhfbins,hfbins);
  ...
  hnSig2spt->Draw();
  //hnSig2spt->Fit("pol1");
  TLine *nSig2sptlineLow = new TLine(0,0,120,0);
  ...
  hnSig3spt->Draw();
  //hnSig3spt->Fit("pol1");
  TLine *nSig3sptlineLow = new TLine(0,0,120,0);
  ...
  //draw rapidity plots
  calpha->cd(2);
  halphay->SetXTitle("E_T^HF");
  halphay->GetYaxis()->SetRangeUser(0,5);
  halphay->Draw();
  //halphay->Fit("pol1");
  TLine *alphaylineLow = new TLine(0,paramslower[2],120,paramslower[2]);
  alphaylineLow->SetLineColor(kRed);
  alphaylineLow->Draw();
  TLine *alphaylineHigh = new TLine(0,paramsupper[2],120,paramsupper[2]);
  alphaylineHigh->SetLineColor(kRed);
  alphaylineHigh->Draw();

  cf1s->cd(2);
  hf1sy->SetXTitle("E_T^HF");
  hf1sy->GetYaxis()->SetRangeUser(-1,2);
  hf1sy->Draw();
  //hf1sy->Fit("pol1");
  TLine *f1sylineLow = new TLine(0,paramslower[4],120,paramslower[4]);
  f1sylineLow->SetLineColor(kRed);
  f1sylineLow->Draw();
  TLine *f1sylineHigh = new TLine(0,paramsupper[4],120,paramsupper[4]);
  f1sylineHigh->SetLineColor(kRed);
  f1sylineHigh->Draw();

  cmass->cd(2);
  hmassy->SetXTitle("E_T^HF");
  hmassy->GetYaxis()->SetRangeUser(9.35,9.6);
  hmassy->Draw();
  //hmassy->Fit("pol1");
  TLine *massylinepdg = new TLine(0,9.46,120,9.46);
  massylinepdg->SetLineColor(3);
  massylinepdg->Draw();
  TLine *massylineLow = new TLine(0,9.36,120,9.36);
  massylineLow->SetLineColor(kRed);
  massylineLow->Draw();
  TLine *massylineHigh = new TLine(0,9.56,120,9.56);
  massylineHigh->SetLineColor(kRed);
  massylineHigh->Draw();

  cn1s->cd(2);
  hn1sy->SetXTitle("E_T^HF");
  hn1sy->GetYaxis()->SetRangeUser(-0.2,5.2);
  hn1sy->Draw();
  //hn1sy->Fit("pol1");
  TLine *n1sylineLow = new TLine(0,paramslower[3],120,paramslower[3]);
  n1sylineLow->SetLineColor(kRed);
  n1sylineLow->Draw();
  TLine *n1sylineHigh = new TLine(0,paramsupper[3],120,paramsupper[3]);
  n1sylineHigh->SetLineColor(kRed);
  n1sylineHigh->Draw();

  csigma1s->cd(2);
  hsigma1sy->SetXTitle("E_T^HF");
  hsigma1sy->GetYaxis()->SetRangeUser(-0.1,0.6);
  hsigma1sy->Draw();
  //hsigma1sy->Fit("pol1");
  TLine *sigmaylineLow = new TLine(0,paramslower[0],120,paramslower[0]);
  sigmaylineLow->SetLineColor(kRed);
  sigmaylineLow->Draw();
  TLine *sigmaylineHigh = new TLine(0,paramsupper[0],120,paramsupper[0]);
  sigmaylineHigh->SetLineColor(kRed);
  sigmaylineHigh->Draw();

  cx1s->cd(2);
  hx1sy->SetXTitle("E_T^HF");
  hx1sy->GetYaxis()->SetRangeUser(0.0,8);
  hx1sy->Draw();
  //hx1sy->Fit("pol1");
  TLine *x1sylineLow = new TLine(0,paramslower[1],120,paramslower[1]);
  x1sylineLow->SetLineColor(kRed);
  x1sylineLow->Draw();
  TLine *x1sylineHigh = new TLine(0,paramsupper[1],120,paramsupper[1]);
  x1sylineHigh->SetLineColor(kRed);
  x1sylineHigh->Draw();

  cerrmu->cd(2);
  herrmuy->SetXTitle("E_T^HF");
