...
//*****************************************************************************
  ...
  PPws->pdf("PPmodel")->plotOn(RpAmyPlot2,Name("PPmodelHistRpA"),LineColor(kRed),LineWidth(2),LineStyle(2),Normalization(PPNorm,RooAbsReal::NumEvent));
