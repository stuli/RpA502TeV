...
void SuperRpARAAPlot_SameBkg_withoutPull( 
       int collId = kAADATA,  
...
if (whichModel) {
  ...
  //float scalefactor = Nomws->var("nBkg")->getVal()/PPNomws->var("nBkg")->getVal();
  float scalefactor = Nomws->var("nSig1s")->getVal()/PPNomws->var("nSig1s")->getVal()/RAA1;
  ...
  double PPnSig1s_init = PPNomws->var("nSig1s")->getVal()*scalefactor;
  double PPnSig2s_init = PPNomws->var("nSig2s")->getVal()*scalefactor;
  double PPnSig3s_init = PPNomws->var("nSig3s")->getVal()*scalefactor;
...
if (whichModel) {
  ...
  //float PAscalefactor = (AAeff/PAeff)*(AAlum/PAlum)*A;
  //float PAscalefactor = Nomws->var("nBkg")->getVal()/PANomws->var("nBkg")->getVal();
  //float PAscalefactor = (PAeff/PPeff)*(PAlum/PPlum)*A;
  float PAscalefactor = Nomws->var("nSig1s")->getVal()*RpA1/(PANomws->var("nSig1s")->getVal()*RAA1);
...
//*****************************************************************************
  ...
  float PPNorm = (PPNomws->var("nSig1s")->getVal()*scalefactor) + (PPNomws->var("nSig2s")->getVal()*scalefactor) + (PPNomws->var("nSig3s")->getVal()*scalefactor) + (Nomws->var("nBkg")->getVal());
  ...
  PPws->pdf("PPmodel")->plotOn(RpAmyPlot2,Name("PPmodelHistRpA"),LineColor(kRed),LineWidth(2),LineStyle(2),Normalization(PPNorm,RooAbsReal::NumEvent),Range(8.8,10.8),NormRange("full"));
  ...
  RpAfitleg->AddEntry(RpAmyPlot2->findObject("dataOS_FIT"),"PbPb Data","pe");
  ...
  RpAfitleg->AddEntry(RpAmyPlot2->findObject("PAmodelHistRpA"),"pPb rescaled","l");
  RpAfitleg->AddEntry(RpAmyPlot2->findObject("PPmodelHistRpA"),"pp rescaled","l");
  RpAfitleg->Draw("same");
  ...
  cout << "AAnSig1s = " << nSig1s_init << endl;
  cout << "AAnSig2s = " << nSig2s_init << endl;
  cout << "AAnSig3s = " << nSig3s_init << endl;
  ...
  cout << "PPscalefactor = " << scalefactor << endl;
  cout << "PPnSig1s = " << PPnSig1s_init << endl;
  cout << "PPnSig2s = " << PPnSig2s_init << endl;
  cout << "PPnSig3s = " << PPnSig3s_init << endl;
