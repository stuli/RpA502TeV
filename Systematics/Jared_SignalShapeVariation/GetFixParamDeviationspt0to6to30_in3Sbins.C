...
using namespace std;
void GetFixParamDeviationspt0to6to30_in3Sbins(int whichUpsilon = 1, TString whichParam="alpha") {
  ...
  TString outFileName = Form("FixParamErrors/Param%sDev%is_pt0to6to30_in3Sbins.root",whichParam.Data(),whichUpsilon);
