...
using namespace std;
void NewGetErrorEstimatespt0to6to30_in3Sbins(int whichUpsilon = 1) {
  ...
  TString outFileName = Form("ErrorEstimates/SystematicErrorSignal%is_pt0to6to30_in3Sbins.root",whichUpsilon);
