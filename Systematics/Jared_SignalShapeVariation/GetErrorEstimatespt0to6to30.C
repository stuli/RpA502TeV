...
using namespace std;
void GetErrorEstimatespt0to6to30(int whichUpsilon = 1) {
  ...
  if (PPtoo) {
    ...
    else if (whichUpsilon==2) ntuple2sy->Fill(binLow,binHigh,PPerr,temperr,RpAerr,ratioerrPP,ratioerr,DRerr);
    else if (whichUpsilon==3) ntuple3sy->Fill(binLow,binHigh,PPerr,temperr,RpAerr,ratioerrPP,ratioerr,DRerr);
