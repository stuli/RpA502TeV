...
if (whichModel) {
  ...
  RooRealVar *nSig2s= new RooRealVar("nSig2s"," 2S signals",0,360000);
  RooRealVar *nSig3s= new RooRealVar("nSig3s"," 3S signals",0,260000);
  ...
  */
  ...
  drawText(Form("%.2f < #Sigma E_{T} < %.2f",hfLow,hfHigh ), pos_text_x,pos_text_y-pos_y_diff*3,text_color,text_size);
