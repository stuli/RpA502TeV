...
if (whichModel) {
  ...
  */
  ...
  if (whichModel) {
    c1->SaveAs(Form("Fixednalpha/altfitresults_upsilon_%s.png",kineLabel.Data()));
    c1->SaveAs(Form("Fixednalpha/altfitresults_upsilon_%s.pdf",kineLabel.Data()));
  }
  else {
    c1->SaveAs(Form("Fixednalpha/nomfitresults_upsilon_%s.png",kineLabel.Data()));
    c1->SaveAs(Form("Fixednalpha/nomfitresults_upsilon_%s.pdf",kineLabel.Data()));
  }
...
TString outFileName;
  if (whichModel){
    outFileName = Form("Fixednalpha/altfitresults_upsilon_%s.root",kineLabel.Data());
  }
  else {
    outFileName = Form("Fixednalpha/nomfitresults_upsilon_%s.root",kineLabel.Data());
  }
