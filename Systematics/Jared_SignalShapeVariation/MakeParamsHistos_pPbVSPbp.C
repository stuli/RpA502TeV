...
void MakeParamsHistos_pPbVSPbp(int collId=kPADATA, int whichUpsilon=1, int whichrun) {
  ...
  TString outfilename = Form("FittedParamsHistos_%s_%is_run%i.root",strId.Data(),whichUpsilon,whichrun);
  TFile outFile(outfilename, "RECREATE");

  //declare histograms
  TH1F* halphapt = new TH1F("halphapt","alpha vs pt",numptbins,shiftedptbins);
  TH1F* hf1spt = new TH1F("hf1spt","f1s vs pt",numptbins,shiftedptbins);
  TH1F* hmasspt = new TH1F("hmasspt","mass vs pt",numptbins,shiftedptbins);
  TH1F* hn1spt = new TH1F("hn1spt","n1s vs pt",numptbins,shiftedptbins);
  TH1F* hsigma1spt = new TH1F("hsigma1spt","sigma vs pt",numptbins,shiftedptbins);
  TH1F* hx1spt = new TH1F("hx1spt","x1s vs pt",numptbins,shiftedptbins);
  TH1F* herrmupt = new TH1F("herrmupt","errmu vs pt",numptbins,shiftedptbins);
  TH1F* herrsigmapt = new TH1F("herrsigmapt","errsigma vs pt",numptbins,shiftedptbins);
  TH1F* hlambdapt = new TH1F("hlambdapt","errlambda vs pt",numptbins,shiftedptbins);
  TH1F* hnSig1spt = new TH1F("hnSig1spt","nSig1s vs pt",numptbins,shiftedptbins);
  TH1F* hnSig2spt = new TH1F("hnSig2spt","nSig2s vs pt",numptbins,shiftedptbins);
  TH1F* hnSig3spt = new TH1F("hnSig3spt","nSig3s vs pt",numptbins,shiftedptbins);
  TH1F* hnBkgpt = new TH1F("hnBkgpt","nBkg vs pt",numptbins,shiftedptbins);

  TH1F* halphay = new TH1F("halphay","alpha vs y",numybins,shiftedybins);
  TH1F* hf1sy = new TH1F("hf1sy","f1s vs y",numybins,shiftedybins);
  TH1F* hmassy = new TH1F("hmassy","mass vs y",numybins,shiftedybins);
  TH1F* hn1sy = new TH1F("hn1sy","n1s vs y",numybins,shiftedybins);
  TH1F* hsigma1sy = new TH1F("hsigma1sy","sigma vs y",numybins,shiftedybins);
  TH1F* hx1sy = new TH1F("hx1sy","x1s vs y",numybins,shiftedybins);
  TH1F* herrmuy = new TH1F("herrmuy","errmu vs y",numybins,shiftedybins);
  TH1F* herrsigmay = new TH1F("herrsigmay","errsigma vs y",numybins,shiftedybins);
  TH1F* hlambday = new TH1F("hlambday","errlambda vs y",numybins,shiftedybins);
  TH1F* hnSig1sy = new TH1F("hnSig1sy","nSig1s vs y",numybins,shiftedybins);
  TH1F* hnSig2sy = new TH1F("hnSig2sy","nSig2s vs y",numybins,shiftedybins);
  TH1F* hnSig3sy = new TH1F("hnSig3sy","nSig3s vs y",numybins,shiftedybins);
  TH1F* hnBkgy = new TH1F("hnBkgy","nBkg vs y",numybins,shiftedybins);
  ...
  for (int ipt = 0; ipt<numptbins; ipt++) {
    ...
    if (whichrun==1) NomFileName = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/PAFitsRun1WithN2/nomfitresults_upsilon_%s.root",kineLabel.Data());
    else if (whichrun==2) NomFileName = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/PAFitsRun2WithN2/nomfitresults_upsilon_%s.root",kineLabel.Data());
    else if (whichrun==3) NomFileName = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/FitsWithSimICsn2/nomfitresults_upsilon_%s.root",kineLabel.Data());
