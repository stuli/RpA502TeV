...
void PlotFittedParams_y193to0to193(int whichUpsilon=1, int collId=kPADATA) {
  ...
  TH1F* halphay = new TH1F("halphay","alpha vs pt",numptbins,ptbins);
  TH1F* hf1sy = new TH1F("hf1sy","f1s vs pt",numptbins,ptbins);
  TH1F* hmassy = new TH1F("hmassy","mass vs pt",numptbins,ptbins);
  TH1F* hn1sy = new TH1F("hn1sy","n1s vs pt",numptbins,ptbins);
  TH1F* hsigma1sy = new TH1F("hsigma1sy","sigma vs pt",numptbins,ptbins);
  TH1F* hx1sy = new TH1F("hx1sy","x1s vs pt",numptbins,ptbins);
  TH1F* herrmuy = new TH1F("herrmuy","errmu vs pt",numptbins,ptbins);
  TH1F* herrsigmay = new TH1F("herrsigmay","errsigma vs pt",numptbins,ptbins);
  TH1F* hlambday = new TH1F("hlambday","errlambda vs pt",numptbins,ptbins);
  TH1F* hnSig1sy = new TH1F("hnSig1sy","nSig1s vs pt",numptbins,ptbins);
  TH1F* hnSig2sy = new TH1F("hnSig2sy","nSig2s vs pt",numptbins,ptbins);
  TH1F* hnSig3sy = new TH1F("hnSig3sy","nSig3s vs pt",numptbins,ptbins);
  TH1F* hnBkgy = new TH1F("hnBkgy","nBkg vs pt",numptbins,ptbins);
  ...
  //draw rapidity plots
  calpha->cd(2);
  halphay->SetXTitle("pT");
  halphay->GetYaxis()->SetRangeUser(0,5);
  halphay->Draw();
  //halphay->Fit("pol1");
  TLine *alphaylineLow = new TLine(0,paramslower[2],30,paramslower[2]);
  alphaylineLow->SetLineColor(kRed);
  alphaylineLow->Draw();
  TLine *alphaylineHigh = new TLine(0,paramsupper[2],30,paramsupper[2]);
  ...
  hf1sy->Draw();
  //hf1sy->Fit("pol1");
  TLine *f1sylineLow = new TLine(0,paramslower[4],30,paramslower[4]);
  f1sylineLow->SetLineColor(kRed);
  f1sylineLow->Draw();
  TLine *f1sylineHigh = new TLine(0,paramsupper[4],30,paramsupper[4]);
  ...
  hmassy->Draw();
  //hmassy->Fit("pol1");
  TLine *massylinepdg = new TLine(0,9.46,30,9.46);
  massylinepdg->SetLineColor(3);
  massylinepdg->Draw();
  TLine *massylineLow = new TLine(0,9.36,30,9.36);
  massylineLow->SetLineColor(kRed);
  massylineLow->Draw();
  TLine *massylineHigh = new TLine(0,9.56,30,9.56);
  ...
  hn1sy->Draw();
  //hn1sy->Fit("pol1");
  TLine *n1sylineLow = new TLine(0,paramslower[3],30,paramslower[3]);
  n1sylineLow->SetLineColor(kRed);
  n1sylineLow->Draw();
  TLine *n1sylineHigh = new TLine(0,paramsupper[3],30,paramsupper[3]);
  n1sylineHigh->SetLineColor(kRed);
  n1sylineHigh->Draw();

  csigma1s->cd(2);
  hsigma1sy->SetXTitle("pT");
  hsigma1sy->GetYaxis()->SetRangeUser(-0.1,0.6);
  hsigma1sy->Draw();
  //hsigma1sy->Fit("pol1");
  TLine *sigmaylineLow = new TLine(0,paramslower[0],30,paramslower[0]);
  sigmaylineLow->SetLineColor(kRed);
  sigmaylineLow->Draw();
  TLine *sigmaylineHigh = new TLine(0,paramsupper[0],30,paramsupper[0]);
  ...
  hx1sy->Draw();
  //hx1sy->Fit("pol1");
  TLine *x1sylineLow = new TLine(0,paramslower[1],30,paramslower[1]);
  x1sylineLow->SetLineColor(kRed);
  x1sylineLow->Draw();
  TLine *x1sylineHigh = new TLine(0,paramsupper[1],30,paramsupper[1]);
  x1sylineHigh->SetLineColor(kRed);
  x1sylineHigh->Draw();

  cerrmu->cd(2);
  herrmuy->SetXTitle("pT");
  ...
  hnBkgy->Draw();
  //hnBkgy->Fit("pol1");
  TLine *nBkgylineLow = new TLine(0,0,30,0);
