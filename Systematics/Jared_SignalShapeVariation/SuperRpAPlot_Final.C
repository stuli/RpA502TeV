...
//*****************************************************************************
  ...
  TString NomFileName = Form("/home/jared/Desktop/CMS_Research/RpA502TeV/SignalFitting/FitsWithSimICs/nomfitresults_upsilon_%s.root",kineLabel.Data());
...
//*****************************************************************************
  ...
  TString PPNomFileName = Form("/home/jared/Desktop/CMS_Research/RpA502TeV/SignalFitting/FitsWithSimICs/nomfitresults_upsilon_%s.root",PPkineLabel.Data());
...
//*****************************************************************************
  ...
  RpAc1->cd();
  TPad *RpApad1 = new TPad("RpApad1", "RpApad1", 0.03, 0.0, 0.98, 1.0);
  ...
  RpAmyPlot2->GetYaxis()->SetTitleOffset(1.5);
  RpAmyPlot2->GetYaxis()->CenterTitle();
  //RpAmyPlot2->GetYaxis()->SetTitleSize(0.058);
  RpAmyPlot2->GetYaxis()->SetTitleSize(0.050);
  //RpAmyPlot2->GetYaxis()->SetLabelSize(0.054);
  RpAmyPlot2->GetYaxis()->SetLabelSize(0.04);
  RpAmyPlot2->GetXaxis()->SetTitle("m_{#mu^{+}#mu^{-}} (GeV/c^{2})");
  //RpAmyPlot2->GetXaxis()->SetLabelSize(0.054);
  RpAmyPlot2->GetXaxis()->SetLabelSize(0.04);
  ...
  RpAfitleg->AddEntry(RpAmyPlot2->findObject("PPmodelHistRpA"),"pp overlaid scaled by A","l");
  RpAfitleg->Draw("same");
