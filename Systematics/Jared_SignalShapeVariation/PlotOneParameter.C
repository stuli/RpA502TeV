...
void PlotOneParameter(int collId=kPPDATA, int whichUpsilon=1, int whichParam=1) {
  ...
  TString HistoFileName = Form("FittedParamsHistos_%s_%is_fixedn%i.root",strId.Data(),whichUpsilon,3);
  ...
  TString NewHistoFileName = Form("FittedParamsHistos_%s_%is_fixedn%i.root",strId.Data(),whichUpsilon,2);
  ...
  TString NewerHistoFileName = Form("FittedParamsHistos_%s_%is_fixedn%i.root",strId.Data(),whichUpsilon,4);
  ...
  nBkgLegend1->AddEntry(NewhParampt,"n=2","p");
  nBkgLegend1->AddEntry(hParampt,"n=3","p");
  ...
  nBkgLegend->AddEntry(NewhParamy,"n=2","p");
  nBkgLegend->AddEntry(hParamy,"n=3","p");
  nBkgLegend->AddEntry(NewerhParamy,"n=4","p");
  nBkgLegend->Draw("same");

  //save plots
  cParam1->SaveAs(Form("ParameterPlots/%sfitted_%s_%isPtbins_compare.png",strId.Data(),paramNames[whichParam].Data(),whichUpsilon));
  cParam2->SaveAs(Form("ParameterPlots/%sfitted_%s_%isYbins_compare.png",strId.Data(),paramNames[whichParam].Data(),whichUpsilon));
