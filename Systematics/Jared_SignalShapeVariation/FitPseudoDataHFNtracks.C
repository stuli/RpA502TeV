...
void FitPseudoDataHFNtracks( 
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=-1.93, float yHigh=-1.2,
       int cLow=0, int cHigh=200,
       float muPtCut=4.0,
       float hfLow=0.0, float hfHigh=400,
       int ntracksLow=0, int ntracksHigh=20,
			...
			)
{
  ...
  TString NomFileName = Form("../NtracksFits/nomfitresults_upsilon_%s.root",kineLabel.Data());
