...
void PlotFittedParams_y193to0to193SinglePlots(int whichUpsilon=1, int collId=kPADATA) {
...
if (collId==kPADATA) {
  ...
  TH1F* halphay = new TH1F("halphay","alpha vs pt",numptbins,ptbinsptr);
  TH1F* hf1sy = new TH1F("hf1sy","f1s vs pt",numptbins,ptbinsptr);
  TH1F* hmassy = new TH1F("hmassy","mass vs pt",numptbins,ptbinsptr);
  TH1F* hn1sy = new TH1F("hn1sy","n1s vs pt",numptbins,ptbinsptr);
  TH1F* hsigma1sy = new TH1F("hsigma1sy","sigma vs pt",numptbins,ptbinsptr);
  TH1F* hx1sy = new TH1F("hx1sy","x1s vs pt",numptbins,ptbinsptr);
  TH1F* herrmuy = new TH1F("herrmuy","errmu vs pt",numptbins,ptbinsptr);
  TH1F* herrsigmay = new TH1F("herrsigmay","errsigma vs pt",numptbins,ptbinsptr);
  TH1F* hlambday = new TH1F("hlambday","errlambda vs pt",numptbins,ptbinsptr);
  TH1F* hnSig1sy = new TH1F("hnSig1sy","nSig1s vs pt",numptbins,ptbinsptr);
  TH1F* hnSig2sy = new TH1F("hnSig2sy","nSig2s vs pt",numptbins,ptbinsptr);
  TH1F* hnSig3sy = new TH1F("hnSig3sy","nSig3s vs pt",numptbins,ptbinsptr);
  TH1F* hnBkgy = new TH1F("hnBkgy","nBkg vs pt",numptbins,ptbinsptr);
  ...
  //1S forward loop
  for (int iy = 0; iy<numptbins; iy++) {

    ptLow = *(ptbinsptr+iy);
    ptHigh = *(ptbinsptr+iy+1);
    if (collId==kPADATA) {
      yLow = 0.0;
      yHigh = 1.93;
    }
  ...
  //save plots
  calpha->SaveAs(Form("ParameterPlots/%sfitted_alpha_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cf1s->SaveAs(Form("ParameterPlots/%sfitted_f1s_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cmass->SaveAs(Form("ParameterPlots/%sfitted_mass_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cn1s->SaveAs(Form("ParameterPlots/%sfitted_n1s_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  csigma1s->SaveAs(Form("ParameterPlots/%sfitted_sigma1s_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cx1s->SaveAs(Form("ParameterPlots/%sfitted_x1s_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cerrmu->SaveAs(Form("ParameterPlots/%sfitted_errmu_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cerrsigma->SaveAs(Form("ParameterPlots/%sfitted_errsigma_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  clambda->SaveAs(Form("ParameterPlots/%sfitted_lambda_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cnSig1s->SaveAs(Form("ParameterPlots/%sfitted_nSig1s_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cnSig2s->SaveAs(Form("ParameterPlots/%sfitted_nSig2s_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cnSig3s->SaveAs(Form("ParameterPlots/%sfitted_nSig3s_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));
  cnBkg->SaveAs(Form("ParameterPlots/%sfitted_nBkg_%isbins_y193to0to193.png",strId.Data(),whichUpsilon));

  //save pdf plots
  calpha->SaveAs(Form("ParameterPlots/%sfitted_alpha_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cf1s->SaveAs(Form("ParameterPlots/%sfitted_f1s_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cmass->SaveAs(Form("ParameterPlots/%sfitted_mass_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cn1s->SaveAs(Form("ParameterPlots/%sfitted_n1s_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  csigma1s->SaveAs(Form("ParameterPlots/%sfitted_sigma1s_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cx1s->SaveAs(Form("ParameterPlots/%sfitted_x1s_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cerrmu->SaveAs(Form("ParameterPlots/%sfitted_errmu_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cerrsigma->SaveAs(Form("ParameterPlots/%sfitted_errsigma_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  clambda->SaveAs(Form("ParameterPlots/%sfitted_lambda_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cnSig1s->SaveAs(Form("ParameterPlots/%sfitted_nSig1s_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cnSig2s->SaveAs(Form("ParameterPlots/%sfitted_nSig2s_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cnSig3s->SaveAs(Form("ParameterPlots/%sfitted_nSig3s_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
  cnBkg->SaveAs(Form("ParameterPlots/%sfitted_nBkg_%isbins_y193to0to193.pdf",strId.Data(),whichUpsilon));
/*
