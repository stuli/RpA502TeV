...
using namespace std;
void NewJaebeomStyle_JustFixedParams(int whichUpsilon=1, bool takeAvg=kFALSE) {

  TString avg = "";
  if (takeAvg) avg = "avg";

  TString filename = Form("FixParamErrors/ParamDev%isCombined.root",whichUpsilon);
  //TString filename2 = Form("FixParamErrors/ParamDev%isCombined_pt0to6to30.root",whichUpsilon);
  TString filename3 = Form("FixParamErrors/ParamDev%isCombined_y193to000to193.root",whichUpsilon);
  TString filename4 = Form("FixParamErrors/ParamDev%isCombined_hfbins.root",whichUpsilon);
  TString filename5 = Form("FixParamErrors/ParamDev%isCombined_ntracksbins.root",whichUpsilon);
  TString filename6 = Form("FixParamErrors/ParamDev%isCombinedXSBins.root",whichUpsilon);
  ...
  TString filename7 = Form("FixParamErrors/ParamDev%isCombined_pt0to6to30_in3Sbins.root",whichUpsilon);
  TString outfilename = Form("ErrorEstimates/SysSig%is_ParamFixingOnly.root",whichUpsilon);
