...
void MakeParamsHistos_compare(int collId=kPPDATA, int whichUpsilon=1, int whichn=2) {
  ...
  TString outfilename = Form("FittedParamsHistos_%s_%is_fixedn%i.root",strId.Data(),whichUpsilon,whichn);
  ...
  for (int ipt = 0; ipt<numptbins; ipt++) {
    ...
    NomFileName = Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/FitsWithSimICsn%i/nomfitresults_upsilon_%s.root",whichn,kineLabel.Data());
