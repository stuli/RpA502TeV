...
double PtReweight(TLorentzVector* DiMuon, TF1 *Pt_Weights){
        double pT = (DiMuon->Pt());
        return Pt_Weights->Eval(pT);
}
...
void dimuEff_oniaMode2_pp_9_28(
...
std::vector<double> NtracksBinEdges;
std::vector<double> NtracksBin;
std::vector<double> SumET_HFBinEdges;
std::vector<double> SumET_HFBin;
std::vector<double> CenBinEdges;
std::vector<double> CenBin;
...
if(oniaMode ==1){
	...
	rapBin = {-1.565, -1.0,-.6,-.2,.2,.6, 1.0, 1.565};
...
//	myTree->SetBranchStatus("Reco_QQ_mumi_isGoodMuon", 1);
	...
	preCan1->SaveAs(Form("eff_pp9_28/HFWeights_%dS_%s_9_28.png",oniaMode,"pp"));
	...
	preCan2->SaveAs(Form("eff_pp9_28/NtracksWeights_%dS_%s_9_28.png",oniaMode,"pp"));*/
...
// */
	...
	if(!ispPb){
		if(oniaMode == 1){
			f_name = "/home/christos/public_html/protected/Efficiencies/RpA5.02TeV/CompareDataToMC/WeightedFcN_fit/ratioDataMC_PP_DATA_1s_20170816.root";
		}else if(oniaMode ==2){
			f_name = "/home/christos/public_html/protected/Efficiencies/RpA5.02TeV/CompareDataToMC/WeightedFcN_fit/ratioDataMC_PP_DATA_2s_20170816.root";
		}else{
			f_name = "/home/christos/public_html/protected/Efficiencies/RpA5.02TeV/CompareDataToMC/WeightedFcN_fit/ratioDataMC_PP_DATA_3s_20170816.root";
		}
	}else{
		if(oniaMode == 1){
			f_name = "/home/christos/public_html/protected/Efficiencies/RpA5.02TeV/CompareDataToMC/WeightedFcN_fit/ratioDataMC_PA_DATA_1s_20170816.root";
		}else if(oniaMode ==2){
			f_name = "/home/christos/public_html/protected/Efficiencies/RpA5.02TeV/CompareDataToMC/WeightedFcN_fit/ratioDataMC_PA_DATA_2s_20170816.root";
		}else{
			f_name = "/home/christos/public_html/protected/Efficiencies/RpA5.02TeV/CompareDataToMC/WeightedFcN_fit/ratioDataMC_PA_DATA_3s_20170816.root";
		}
	}
...
// */			
				ptReweight = PtReweight(qq4mom, Pt_Weights);
...
c1->SaveAs(Form("eff_pp9_28/EfficiencyCent_%dS_%s_9_28.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c2->SaveAs(Form("eff_pp9_28/EfficiencyPt_%dS_%s_9_28.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pp9_28/EfficiencyRap_%dS_%s_9_28.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pp9_28/EfficiencyInt_%dS_%s_9_28.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c5->SaveAs(Form("eff_pp9_28/EfficiencyNtracks_%dS_%s_9_28.png",oniaMode,"pp"));
...
c6->SaveAs(Form("eff_pp/EfficiencySumET_HF_%dS_%s_9_28.png",oniaMode,"pp"));*/


TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pp9_28/Eff_%s_%dS_9_28.root","pp",oniaMode), "Recreate");
	//EffSumET_HF->Write();
	//EffNtracks->Write();
	EffCent->Write();
	GenEvents->Write();
