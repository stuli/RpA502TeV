...
void dimuEff_oniaMode2_pPb_10_2(
...
//	myTree->SetBranchStatus("Reco_QQ_mumi_isGoodMuon", 1);
	...
	preCan1->SaveAs(Form("eff_pp10_2/HFWeights_%dS_%s_10_2.png",oniaMode,"pp"));
	...
	preCan2->SaveAs(Form("eff_pp10_2/NtracksWeights_%dS_%s_10_2.png",oniaMode,"pp"));*/
...
c1->SaveAs(Form("eff_pPb10_2/EfficiencyCent_%dS_%s_10_2.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c2->SaveAs(Form("eff_pPb10_2/EfficiencyPt_%dS_%s_10_2.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pPb10_2/EfficiencyRap_%dS_%s_10_2.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pPb10_2/EfficiencyInt_%dS_%s_10_2.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c5->SaveAs(Form("eff_pp10_2/EfficiencyNtracks_%dS_%s_10_2.png",oniaMode,"pp"));
...
c6->SaveAs(Form("eff_pp/EfficiencySumET_HF_%dS_%s_10_2.png",oniaMode,"pp"));*/


TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pPb10_2/Eff_%s_%dS_10_2.root","pPb",oniaMode), "Recreate");
	//EffSumET_HF->Write();
	//EffNtracks->Write();
	EffCent->Write();
	GenEvents->Write();
