...
//		int binNumber = hw1->GetXaxis()->FindBin(mupt1);
//cout << binNumber << " is bun bumber " << endl; 
...
void dimuEff_oniaMode2_pPb_11_13_TnPSyspPb_up(
...
c2->SaveAs(Form("eff_pPb11_13_TnPSyspPb_up/EfficiencyPt_%dS_%s_11_13_TnPSyspPb_up.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pPb11_13_TnPSyspPb_up/EfficiencyRap_%dS_%s_11_13_TnPSyspPb_up.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pPb11_13_TnPSyspPb_up/EfficiencyInt_%dS_%s_11_13_TnPSyspPb_up.png",oniaMode, ispPb ? "pPb" : "PP"));


// Writing efficiencies to file
TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pPb11_13_TnPSyspPb_up/Eff_%s_%dS_11_13_TnPSyspPb_up.root","pPb",oniaMode), "Recreate");
RecoEventsInt->Write();
RecoEventsPt->Write();
RecoEventsRap->Write();
GenEventsInt->Write();
