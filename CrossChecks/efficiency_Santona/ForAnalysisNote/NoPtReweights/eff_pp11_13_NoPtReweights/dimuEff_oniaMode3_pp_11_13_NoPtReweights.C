...
void dimuEff_oniaMode3_pp_11_13_NoPtReweights(
...
c2->SaveAs(Form("eff_pp11_13_NoPtReweights/EfficiencyPt_%dS_%s_11_13_NoPtReweights.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pp11_13_NoPtReweights/EfficiencyRap_%dS_%s_11_13_NoPtReweights.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pp11_13_NoPtReweights/EfficiencyInt_%dS_%s_11_13_NoPtReweights.png",oniaMode, ispPb ? "pPb" : "PP"));


// Writing efficiencies to file
TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pp11_13_NoPtReweights/Eff_%s_%dS_11_13_NoPtReweights.root","pp",oniaMode), "Recreate");
RecoEventsInt->Write();
RecoEventsPt->Write();
RecoEventsRap->Write();
GenEventsInt->Write();
