...
void dimuEff_oniaMode1_pPb_11_13_NoPtReweights(
...
c2->SaveAs(Form("eff_pPb11_13_NoPtReweights/EfficiencyPt_%dS_%s_11_13_NoPtReweights.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pPb11_13_NoPtReweights/EfficiencyRap_%dS_%s_11_13_NoPtReweights.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pPb11_13_NoPtReweights/EfficiencyInt_%dS_%s_11_13_NoPtReweights.png",oniaMode, ispPb ? "pPb" : "PP"));


// Writing efficiencies to file
TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pPb11_13_NoPtReweights/Eff_%s_%dS_11_13_NoPtReweights.root","pPb",oniaMode), "Recreate");
RecoEventsInt->Write();
RecoEventsPt->Write();
RecoEventsRap->Write();
GenEventsInt->Write();
