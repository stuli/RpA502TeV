...
void dimuEff_oniaMode1_pp_11_13_TnPSysPP_up(
...
c2->SaveAs(Form("eff_pp11_13_TnPSysPP_up/EfficiencyPt_%dS_%s_11_13_TnPSysPP_up.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pp11_13_TnPSysPP_up/EfficiencyRap_%dS_%s_11_13_TnPSysPP_up.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pp11_13_TnPSysPP_up/EfficiencyInt_%dS_%s_11_13_TnPSysPP_up.png",oniaMode, ispPb ? "pPb" : "PP"));


// Writing efficiencies to file
TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pp11_13_TnPSysPP_up/Eff_%s_%dS_11_13_TnPSysPP_up.root","pp",oniaMode), "Recreate");
RecoEventsInt->Write();
RecoEventsPt->Write();
RecoEventsRap->Write();
GenEventsInt->Write();
