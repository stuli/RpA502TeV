...
void dimuEff_oniaMode1_pp_11_13_Nominal(
...
c2->SaveAs(Form("eff_pp11_13_Nominal/EfficiencyPt_%dS_%s_11_13_Nominal.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pp11_13_Nominal/EfficiencyRap_%dS_%s_11_13_Nominal.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pp11_13_Nominal/EfficiencyInt_%dS_%s_11_13_Nominal.png",oniaMode, ispPb ? "pPb" : "PP"));


// Writing efficiencies to file
TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pp11_13_Nominal/Eff_%s_%dS_11_13_Nominal.root","pp",oniaMode), "Recreate");
RecoEventsInt->Write();
RecoEventsPt->Write();
RecoEventsRap->Write();
GenEventsInt->Write();
