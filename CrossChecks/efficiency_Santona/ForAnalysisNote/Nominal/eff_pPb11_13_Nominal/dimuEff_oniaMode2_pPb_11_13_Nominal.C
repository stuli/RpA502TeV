...
void dimuEff_oniaMode2_pPb_11_13_Nominal(
...
c2->SaveAs(Form("eff_pPb11_13_Nominal/EfficiencyPt_%dS_%s_11_13_Nominal.png",oniaMode, ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pPb11_13_Nominal/EfficiencyRap_%dS_%s_11_13_Nominal.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pPb11_13_Nominal/EfficiencyInt_%dS_%s_11_13_Nominal.png",oniaMode, ispPb ? "pPb" : "PP"));


// Writing efficiencies to file
TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pPb11_13_Nominal/Eff_%s_%dS_11_13_Nominal.root","pPb",oniaMode), "Recreate");
RecoEventsInt->Write();
RecoEventsPt->Write();
RecoEventsRap->Write();
GenEventsInt->Write();
