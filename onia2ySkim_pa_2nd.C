...
void onia2ySkim_pa_2nd( int nevt = -1,
		 int fileID = kPADATA,
		 ...
		 ) 
{
  ...
  if (fileID == kPADATA) {
    newfile = new TFile(Form("skimmedFiles/yskimPA2nd_%s_%s_%s.root",fdimusign.Data(), getDayAndTime().Data(), skimVersion.Data() ),"recreate");   
  }
