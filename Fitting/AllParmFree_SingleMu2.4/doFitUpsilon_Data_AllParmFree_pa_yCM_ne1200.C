...
void doFitUpsilon_Data_AllParmFree_pa_yCM_ne1200(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=-0.73, float yHigh=0.47,
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.693, 3.322);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.235 , 1.520, 3.237);
