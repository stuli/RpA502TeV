...
void doFitUpsilon_Data_AllParmFree_pa_yCM_po0408(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=0.87, float yHigh=1.27,
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.321, 3.302);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.205 , 1.413, 3.217);
