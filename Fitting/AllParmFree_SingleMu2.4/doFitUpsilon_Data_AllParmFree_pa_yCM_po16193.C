...
void doFitUpsilon_Data_AllParmFree_pa_yCM_po16193(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=2.07, float yHigh=2.4,
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.421, 3.301);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.022 , 1.302, 3.022);
  ...
  RooRealVar *nSig2s= new RooRealVar("nSig2s"," 2S signals",-10,360000);
  RooRealVar *nSig3s= new RooRealVar("nSig3s"," 3S signals",-30,260000);
