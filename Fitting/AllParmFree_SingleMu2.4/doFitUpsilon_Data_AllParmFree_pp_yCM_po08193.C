...
void doFitUpsilon_Data_AllParmFree_pp_yCM_po08193(
       int collId = kPPDATA,  
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.403, 3.322);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.235 , 1.503, 3.217);
