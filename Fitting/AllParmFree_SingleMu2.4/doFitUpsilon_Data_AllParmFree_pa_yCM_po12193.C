...
void doFitUpsilon_Data_AllParmFree_pa_yCM_po12193(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=1.67, float yHigh=2.4,
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.401, 3.322);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.235 , 1.530, 3.237);
