...
void doFitUpsilon_Data_AllParmFree_pa_yCM_ne19316(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=-1.46, float yHigh=-1.13,
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.80, 3.122);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.034 , 1.742, 2.937);
