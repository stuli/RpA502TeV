...
void doFitUpsilon_Data_AllParmFree_pa_yCM_ne0804(
       int collId = kPADATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=-0.33, float yHigh=0.07,
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.431, 3.312);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.265 , 1.424, 3.217);
