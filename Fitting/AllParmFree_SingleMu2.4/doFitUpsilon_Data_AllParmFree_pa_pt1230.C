...
void doFitUpsilon_Data_AllParmFree_pa_pt1230(
       int collId = kPADATA,  
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.431, 3.301);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.261 , 1.530, 3.355);
