...
void doFitUpsilon_Data_AllParmFree_pa_pt630(
       int collId = kPADATA,  
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.653, 3.302);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.265 , 1.591, 3.357);
