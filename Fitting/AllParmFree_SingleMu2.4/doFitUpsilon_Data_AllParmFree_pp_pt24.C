...
void doFitUpsilon_Data_AllParmFree_pp_pt24(
       int collId = kPPDATA,  
       ...
       )
{
  ...
  if ( collId == kPADATA) 
  {
    f1 = new TFile("/home/deathold/work/CMS/analysis/Upsilon_RpA/UpsilonpPb5TeV/skimmedFiles/yskimPP_L1DoubleMu0PD_Trig-L1DoubleMu0_OpSign_20164251755_3964bbec2f15f2cf9baa0676644690f40cee27c4.root");
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.621, 3.331);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.265 , 1.616, 3.357);
