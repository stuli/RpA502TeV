...
void doFitUpsilon_Data_AllParmFree_pp_pt06(
       int collId = kPPDATA,  
       ...
       )
{
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.071 , 1.451, 3.331);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.265 , 1.417, 3.357);
