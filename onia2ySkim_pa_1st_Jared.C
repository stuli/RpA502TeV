...
void onia2ySkim_pa_1st_Jared( int nevt = -1,
		 int fileID = kPADATA,
		 ...
		 ) 
{
  ...
  if (fileID == kPADATA) {
    ...
    fname = "/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/RD2013_pa_1st_run_merged.root";
    mytree->Add(fname.Data());
  }
  ...
  if (fileID == kPADATA) {
    newfile = new TFile(Form("Jared_yskimPA1st_%s_%s_%s.root",fdimusign.Data(), getDayAndTime().Data(), skimVersion.Data() ),"recreate");   
  }
