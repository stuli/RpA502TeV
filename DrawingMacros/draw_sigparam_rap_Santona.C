...
int draw_sigparam_rap(TString szAA = "PP", int states =1)
{
  /////////////////////////////////////////////////////////
  //// set style
  /////////////////////////////////////////////////////////
...
//    ws[ib]= (RooWorkspace*)fileIn[ib]->Get("workspace");
  ...
  //// histogram
  TH1D* h1_alpha1s = new TH1D("h1_alpha1s","h1_alpha1s;|y|;alpha1s",nBin,binArr); 
  TH1D* h1_n1s = new TH1D("h1_n1s","h1_n1s;|y|;n1s",nBin,binArr); 
  ...
  c_alpha1s->SaveAs(Form("sigparam/rap_alpha1s_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_n1s->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_n1s->SaveAs(Form("sigparam/rap_n1s_%s_%dS.pdf",szAA.Data(),states));
  ...
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_sigma1s_1->SaveAs(Form("sigparam/rap_sigma1s_1_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_f1s->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_f1s->SaveAs(Form("sigparam/rap_f1s_%s_%dS.pdf",szAA.Data(),states));
  ...
  h1_x1s->Draw("pe");
  latex->DrawLatex(0.45,0.83,Form("%s, binning for #Upsilon(%dS)",szAA.Data(),states));
  c_x1s->SaveAs(Form("sigparam/rap_x1s_%s_%dS.pdf",szAA.Data(),states));
