...
int draw_yield_cent_OldvsNew(int states =1, TString ColId = "PP")
{
  /////////////////////////////////////////////////////////
  //// set style
  /////////////////////////////////////////////////////////
  ...
  for (int ib =0; ib < nBin; ib ++ ) {
   ...
   if(ColId=="AA"){
   fileIn1[ib]= new TFile(Form("/cms/home/goni/work/Analysis/Upsilon_Raa_8_0_24/src/usercode/upsilonRAA5TeV/fitResults/NominalFits/fitresults_upsilon_DoubleCB_AA_DATA_pt0.0-30.0_y0.0-2.4_muPt4.0_centrality%.0f-%.0f_dphiEp_0.00PI_100.00PI.root",binArr[ib],binArr[ib+1]));
   fileIn2[ib]= new TFile(Form("/cms/home/goni/work/Analysis/Upsilon_Raa_8_0_24/src/usercode/upsilonRAA5TeV/fitResults/NominalFits/PAS_fitresults_upsilon_DoubleCB_AA_DATA_pt0.0-30.0_y0.0-2.4_muPt4.0_centrality%.0f-%.0f_dphiEp_0.00PI_100.00PI.root",binArr[ib],binArr[ib+1])); }
   if(ColId=="PP"){
   fileIn1[ib]= new TFile(Form("/cms/home/goni/work/Analysis/Upsilon_Raa_8_0_24/src/usercode/upsilonRAA5TeV/fitResults/NominalFits/fitresults_upsilon_DoubleCB_PP_DATA_pt0.0-30.0_y0.0-2.4_muPt4.0.root",binArr[ib],binArr[ib+1]));
   fileIn2[ib]= new TFile(Form("/cms/home/goni/work/Analysis/Upsilon_Raa_8_0_24/src/usercode/upsilonRAA5TeV/fitResults/NominalFits/PAS_fitresults_upsilon_DoubleCB_PP_DATA_pt0.0-30.0_y0.0-2.4_muPt4.0.root",binArr[ib],binArr[ib+1])); }
