...
void dimuEff_oniaMode2_pPb_HFeta29_5(
...
cout << ptBinEdges << endl;
	...
	preCan1->SaveAs(Form("eff_pPb/HFWeights_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
	...
	preCan2->SaveAs(Form("eff_pPb/NtracksWeights_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
...
// */
			...
			if (rapLow < rapReco < rapHigh && ptReco < 30 && Centrality < 200&&TMath::Abs(qq4mom->Eta())<5&&TMath::Abs(qq4mom->Eta())>2.9){
...
//			rapGen = TMath::Abs(g_qq4mom->Rapidity());
			...
			if (rapLow < rapGen < rapHigh && ptGen < 30 && Centrality < 200 &&TMath::Abs(g_qq4mom->Eta())<5&&TMath::Abs(g_qq4mom->Eta())>2.9){
...
c1->SaveAs(Form("eff_pPb/EfficiencyCent_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
}
...
c2->SaveAs(Form("eff_pPb/EfficiencyPt_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c3->SaveAs(Form("eff_pPb/EfficiencyRap_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c4->SaveAs(Form("eff_pPb/EfficiencyInt_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
...
c5->SaveAs(Form("eff_pPb/EfficiencyNtracks_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
}
...
c6->SaveAs(Form("eff_pPb/EfficiencySumET_HF_%dS_%s_HFeta29_5.png",oniaMode,ispPb ? "pPb" : "PP"));
}

TFile* MyFileEff;
MyFileEff = new TFile(Form("eff_pPb/Eff_%s_%dS_HFeta29_5.root",ispPb ? "pPb" : "PP",oniaMode), "Recreate");
if(ispPb){
	EffSumET_HF->Write();
	EffNtracks->Write();
	EffCent->Write();
