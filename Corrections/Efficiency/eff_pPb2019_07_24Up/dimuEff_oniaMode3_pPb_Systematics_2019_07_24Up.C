...
void dimuEff_oniaMode3_pPb_Systematics_2019_07_24Up(
...
bool ispPb = 1 //true = pPb and false = pp
	...
	if(isRpA2D){
		...
		c1->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyPtRpArapPos_%dS_%s_2019_07_24Up.png",oniaMode, ispPb ? "pPb" : "PP"));
		...
		c2->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyPtRpArapNeg_%dS_%s_2019_07_24Up.png",oniaMode, ispPb ? "pPb" : "PP"));
		...
		c3->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyRapRpAlowpT_%dS_%s_2019_07_24Up.png",oniaMode, ispPb ? "pPb" : "PP"));
		...
		c4->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyRapRpAhighpT_%dS_%s_2019_07_24Up.png",oniaMode, ispPb ? "pPb" : "PP"));
	}
	...
	// Declare graphs, set styles and make plots for RpA and Cross section study
		...
		c2->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyPt_%dS_%s_2019_07_24Up.png",oniaMode, ispPb ? "pPb" : "PP"));
		...
		c1->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyPtRpA_%dS_%s_2019_07_24Up.png",oniaMode, ispPb ? "pPb" : "PP"));
		...
		c3->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyRap_%dS_%s_2019_07_24Up.png",oniaMode,ispPb ? "pPb" : "PP"));	
	    ...
	    c4->SaveAs(Form("eff_pPb2019_07_24Up/EfficiencyRapRpA_%dS_%s_2019_07_24Up.png",oniaMode,ispPb ? "pPb" : "PP"));
	}
	// Done making all efficiency plots

	// Writing efficiencies to root files
	TFile* MyFileEff;
	MyFileEff = new TFile(Form("eff_pPb2019_07_24Up/Eff_%s_%dS_2019_07_24Up.root","pPb",oniaMode), "Recreate");
	hCrossCheck->Write();
