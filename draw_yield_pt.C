...
int draw_yield_pt(TString szAA = "PP", int states =1)
{
  ...
  for (int ib =0; ib < nBin; ib ++ ) {
    ...
    else if (szAA == "PA" ) { fileIn[ib]= new TFile(Form("/home/deathold/work/CMS/analysis/Upsilon_RpA/UpsilonpPb5TeV/Fitting/AllParmFree/AllParmFree_fitresults_upsilon_DoubleCB_5TeV_%s_DATA_pt%.1f-%.1f_y-1.93-1.93_muPt4.0.root",szAA.Data(),binArr[ib],binArr[ib+1])); }
