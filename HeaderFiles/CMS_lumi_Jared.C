...
void 
CMS_lumi_Jared( TPad* pad, int iPeriod, int iPosX )
{            
  ...
  if( iPeriod==1 )
    ...
    {
      lumiText += "Pbp ";
      lumiText += lumi_pPb502TeV_run1;
      lumiText += " (5.02 TeV)";
    }
  else if( iPeriod==5 )
    {
      lumiText += "pPb ";
      lumiText += lumi_pPb502TeV_run2;
      lumiText += " (5.02 TeV)";
    }
  else if( iPeriod==100 )
    {
	  ...
	  if( writeExtraText ) 
	    {
	      ...
	      latex.DrawLatex(posX_+ relExtraDY*cmsTextSize*t*0.9, posY_, extraText);
	    }
	}
    }
...
//      latex.DrawLatex(posX_, posY_, extraText);   
      latex.DrawLatex(posX_+relExtraDY*cmsTextSize*t*0.9, posY_+relExtraDY*cmsTextSize*t*1.1, extraText);         
    }
  return;
}
