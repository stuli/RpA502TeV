...
void getSpectra_RpPb_1D_Jared(int state = 1) {  
...
*/
  ...
  TFile* infeff = new TFile(Form("Efficiency/RootFiles/EffNomCor_SysRpA_%dS.root",state),"read");
  TFile* infeff_crossdw = new TFile(Form("Efficiency/RootFiles/EffCor_SyspPbXSAsymm_%dS.root",state),"read");
  TFile* infeff_cross = new TFile(Form("Efficiency/RootFiles/EffCor_SyspPbXSSymm_%dS.root",state),"read");
  TFile* infeffPP_cross = new TFile(Form("Efficiency/RootFiles/EffCor_SysPPXS_%dS.root",state),"read");
...
//  gPad->SetLogy();
 ...
 //*****Draw pt***** 
  ...
  TFile* inf = new TFile(Form("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/Fits/NominalFits_2018_09_25/nomfitresults_upsilon_%s.root",kineLabel.Data()));
