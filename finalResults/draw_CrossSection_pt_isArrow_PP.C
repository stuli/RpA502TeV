...
//  else if (ppAA==1) CMS_lumi( c1, 1, iPos );
  ...
  for (int is=0; is<nState; is++){
    ...
    for (int ipt=0; ipt< npoint[is] ; ipt++) { //bin by bin
      ...
      if(is==0){
      cout << "$\\pt < 2$ \\GeVc & " << Form("%.8f",val[0])  << " & " << Form("%.8f",val_stat[0]) << " & " << Form("%.8f",val_sys[0]) << " \\\\ " << endl;
      cout << "$2 < \\pt < 4$ \\GeVc & " << Form("%.8f",val[1])  << " & " << Form("%.8f",val_stat[1]) << " & " << Form("%.8f",val_sys[1]) << " \\\\ " << endl;
      cout << "$4 < \\pt < 6$ \\GeVc & " << Form("%.8f",val[2])  << " & " << Form("%.8f",val_stat[2]) << " & " << Form("%.8f",val_sys[2]) << " \\\\ " << endl;
      cout << "$6 < \\pt < 9$ \\GeVc & " << Form("%.8f",val[3])  << " & " << Form("%.8f",val_stat[3]) << " & " << Form("%.8f",val_sys[3]) << " \\\\ " << endl;
      cout << "$9 < \\pt < 12$ \\GeVc & " << Form("%.8f",val[4])  << " & " << Form("%.8f",val_stat[4]) << " & " << Form("%.8f",val_sys[4]) << " \\\\ " << endl;
      cout << "$12 < \\pt < 30$ \\GeVc & " << Form("%.8f",val[5])  << " & " << Form("%.8f",val_stat[5]) << " & " << Form("%.8f",val_sys[5]) << " \\\\ " << endl;
      }
      else if(is==1){
      cout << "$\\pt < 4$ \\GeVc & " << Form("%.8f",val[0])  << " & " << Form("%.8f",val_stat[0]) << " & " << Form("%.8f",val_sys[0]) << " \\\\ " << endl;
      cout << "$4 < \\pt < 9$ \\GeVc & " << Form("%.8f",val[1])  << " & " << Form("%.8f",val_stat[1]) << " & " << Form("%.8f",val_sys[1]) << " \\\\ " << endl;
      cout << "$9 < \\pt < 30$ \\GeVc & " << Form("%.8f",val[2])  << " & " << Form("%.8f",val_stat[2]) << " & " << Form("%.8f",val_sys[2]) << " \\\\ " << endl;
      }
      else if(is==2){
      cout << "$\\pt < 6$ \\GeVc & " << Form("%.8f",val[0])  << " & " << Form("%.8f",val_stat[0]) << " & " << Form("%.8f",val_sys[0]) << " \\\\ " << endl;
      cout << "$6 < \\pt < 30$ \\GeVc & " << Form("%.8f",val[1])  << " & " << Form("%.8f",val_stat[1]) << " & " << Form("%.8f",val_sys[1]) << " \\\\ " << endl;
      }
  }
  return;
