...
//  globtex->DrawLatex(0.27, sz_init-sz_shift-sz_step*2, "|#eta^{#mu}| < 2.4");
  ...
  CMS_lumi( c1, 3, iPos );
	...
	c1->Update();
  c1->SaveAs(Form("Comp_Run12_CrossSection_vs_rap_%s%dS_nosys.pdf",sz_ppAA.Data(),State));
  c1->SaveAs(Form("Comp_Run12_CrossSection_vs_rap_%s%dS_nosys.png",sz_ppAA.Data(),State));
