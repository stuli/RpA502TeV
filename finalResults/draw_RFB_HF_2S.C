...
void draw_RFB_HF_2S(bool isArrow=false)
{
  setTDRStyle();
...
//  double relsys = 0.1;
  ...
  double px_1[4] = {15-15/8*1,45-15/8*1,75-15/8*1,105-15/8*1};
  double px_2[4] = {15+15/8*1,45+15/8*1,75+15/8*1,105+15/8*1};

  ////////////////////////////////////////////////////////////////
  //// read input file : value & stat.
  TFile* fIn;
  fIn = new TFile("Ups_2_RFB_HF.root","READ");
...
//  globalUncBox -> Draw("l same");
  ...
  CMS_lumi_raaCent( c1, iPeriod, iPos );
	...
	c1->Update();
  c1->SaveAs("plots/RFB_vs_hf_2S.pdf");
  c1->SaveAs("plots/RFB_vs_hf_2S.png");
