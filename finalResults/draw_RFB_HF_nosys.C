...
void draw_RFB_HF_nosys(bool isArrow=false)
{
  setTDRStyle();
...
//  double relsys = 0.1;
  ...
  double exsys_1s[4] =  {10, 5, 5,40};
  double exsys_2s[4] =  {10,5,5,40};
  double exsys_3s[4] =  {10,5,5,40};
...
//  globtex->DrawLatex(0.22, sz_init-sz_step*2, "Cent. 0-100%");
  ...
  CMS_lumi_raaCent( c1, iPeriod, iPos );
	...
	c1->Update();
  c1->SaveAs("RFB_vs_hf.pdf");
  c1->SaveAs("RFB_vs_hf.png");
