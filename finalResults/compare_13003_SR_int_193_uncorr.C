...
void compare_13003_SR_int_193_uncorr() //1 or 2 (1S or 2S)
{
  setTDRStyle();
...
//  globtex->DrawLatex(0.22, sz_init-sz_step*2, "|#eta^{#mu}| < 2.4");
  ...
  CMS_lumi_raaCent( c1, iPeriod, iPos );
	...
	c1->Update();
  c1->SaveAs("Comp13003_SR_int_asym_193_uncorr.pdf");
  c1->SaveAs("Comp13003_SR_int_asym_193_uncorr.png");
