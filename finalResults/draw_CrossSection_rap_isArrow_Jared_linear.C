...
void draw_CrossSection_rap_isArrow_Jared_linear(int ppAA=1, bool isArrow=false) //1=pp, 2=AA
{
  setTDRStyle();
...
//  double relsys = 0.1;
  ...
  */
  ...
  gCrossSection_sys[0]->SetMinimum(0.0);
  gCrossSection_sys[0]->SetMaximum(2.0);
  ...
  TLegend *leg= new TLegend(0.62, 0.35, 0.83, 0.52);
  SetLegendStyle(leg);
...
//  globtex->DrawLatex(0.27, sz_init-sz_shift-sz_step*2, "|#eta^{#mu}| < 2.4");
  ...
  if (writeExtraText) {
    c1->SaveAs(Form("plots/CrossSection_vs_rap_%s_linear.pdf",sz_ppAA.Data()));
    c1->SaveAs(Form("plots/CrossSection_vs_rap_%s_linear.png",sz_ppAA.Data()));
  }
  else {
    c1->SaveAs(Form("plots/CrossSection_vs_rap_%s_linear_noPreliminary.pdf",sz_ppAA.Data()));
    c1->SaveAs(Form("plots/CrossSection_vs_rap_%s_linear_noPreliminary.png",sz_ppAA.Data()));
  }
  ...
  */
  ...
  gCrossSection_sys_absy[0]->SetMinimum(0.0);
  gCrossSection_sys_absy[0]->SetMaximum(2.0);
  ...
  TLegend *leg_absy= new TLegend(0.62, 0.35, 0.83, 0.52);
...
//  globtex->DrawLatex(0.27, sz_init-sz_shift-sz_step*2, "|#eta^{#mu}| < 2.4");
  ...
  if (writeExtraText) {
    c2->SaveAs(Form("plots/CrossSection_vs_rap_%s_absy_linear.pdf",sz_ppAA.Data()));
    c2->SaveAs(Form("plots/CrossSection_vs_rap_%s_absy_linear.png",sz_ppAA.Data()));
  }
  else {
    c2->SaveAs(Form("plots/CrossSection_vs_rap_%s_absy_linear_noPreliminary.pdf",sz_ppAA.Data()));
    c2->SaveAs(Form("plots/CrossSection_vs_rap_%s_absy_linear_noPreliminary.png",sz_ppAA.Data()));
  }
