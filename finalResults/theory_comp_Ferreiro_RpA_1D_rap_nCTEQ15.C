...
void theory_comp_Ferreiro_RpA_1D_rap_nCTEQ15(int drawState=1)
{
  setTDRStyle();
...
//  leg1->SetHeader("Ferreiro, nCTEQ15+comovers","");
  ...
  CMS_lumi_raaCent( c1, iPeriod, iPos );
	...
	c1->Update();
  c1->SaveAs(Form("plots/Theory_Ferreiro_nCTEQ15_vs_rap_1D_drawState%d.pdf",drawState));
  c1->SaveAs(Form("plots/Theory_Ferreiro_nCTEQ15_vs_rap_1D_drawState%d.png",drawState));
