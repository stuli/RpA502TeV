...
void draw_RFB_NT_1S(bool isArrow=false)
{
  setTDRStyle();
...
//  double relsys = 0.1;
  ...
  double px_1[4] = {50-50/8*3,150-50/8*3,250-50/8*3,350-50/8*3};
  double px_2[4] = {50-50/8*1,150-50/8*1,250-50/8*1,350-50/8*1};
  double px_3[4] = {50+50/8*1,150+50/8*1,250+50/8*1,350+50/8*1};
  double px_4[4] = {50+50/8*3,150+50/8*3,250+50/8*3,350+50/8*3};

  ////////////////////////////////////////////////////////////////
  //// read input file : value & stat.
  TFile* fIn;
  fIn = new TFile("Ups_1_RFB_Ntracks.root","READ");
...
//  globalUncBox -> Draw("l same");
  ...
  CMS_lumi_raaCent( c1, iPeriod, iPos );
	...
	c1->Update();
  c1->SaveAs("plots/RFB_vs_nt_1S.pdf");
  c1->SaveAs("plots/RFB_vs_nt_1S.png");
