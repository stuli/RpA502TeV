...
void draw_RFB_HF_3S(bool isArrow=false)
{
  setTDRStyle();
...
//  double relsys = 0.1;
  ...
  double px_1[4] = {15,45,75,105};

  ////////////////////////////////////////////////////////////////
  //// read input file : value & stat.
  TFile* fIn;
  fIn = new TFile("Ups_3_RFB_HF.root","READ");
...
//  globtex->DrawLatex(0.22, sz_init-sz_step*2, "Cent. 0-100%");
  ...
  CMS_lumi_raaCent( c1, iPeriod, iPos );
	...
	c1->Update();
  c1->SaveAs("plots/RFB_vs_hf_3S.pdf");
  c1->SaveAs("plots/RFB_vs_hf_3S.png");
