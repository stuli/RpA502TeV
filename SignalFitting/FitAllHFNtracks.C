#include <iostream>
//#include "FitDataWithSimultaneousSeedsHFNtracks.C"
#include "FitDataWithInternalConstraintsHFNtracks.C"
  ...
  for (int whichUpsilon = 1; whichUpsilon<=3; whichUpsilon++) {
    ...
    for (int ihf = 0; ihf<numhfbins; ihf++) {
      for (int iy = ystart; iy<numybins; iy++) {
        ...
        //FitDataWithSimultaneousSeedsHFNtracks( collId, ptLow, ptHigh, yLow, yHigh, cLow, cHigh, muPtCut, hfLow, hfHigh, ntracksLow, ntracksHigh, whichModel, nfix, xfix, alphafix);
        FitDataWithInternalConstraintsHFNtracks( collId, ptLow, ptHigh, yLow, yHigh, cLow, cHigh, muPtCut, hfLow, hfHigh, ntracksLow, ntracksHigh, whichModel, changen, changex, changealpha, changef);
      }
    }
