...
double FitMCDataHFNtracksWithnfix( 
       int collId = kPADATA,  
			...
			) 
{
  ...
  if (ntracksHigh-ntracksLow<400) binmode = 1;
  ...
  if (collId==kPADATA) {
    if (binmode==1) {
      ...
      if (whichUpsilon==1) {
        f1 = new TFile("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/DataTrees/Jared_yskimPA1SMC_OpSign_20184686_unIdentified_with_SumET_HF_and_Ntracks.root");
      }
      else if (whichUpsilon==2) {
        f1 = new TFile("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/DataTrees/Jared_yskimPA2SMC_OpSign_20184686_unIdentified_with_SumET_HF_and_Ntracks.root");
      }
      else if (whichUpsilon==3) {
        f1 = new TFile("/media/jared/Acer/Users/Jared/Desktop/Ubuntu_Overflow/DataTrees/Jared_yskimPA3SMC_OpSign_20184685_unIdentified_with_SumET_HF_and_Ntracks.root");
      }
    }
    else if (binmode==0) {
...
if (whichModel) {
  ...
  //fix parameters
  if (collId==kPADATA) n1s_1.setVal(2.45528);
  else if (collId==kPPDATA) n1s_1.setVal(1.38446);
  n1s_1.setConstant();
  ...
  if (whichModel) {
    c1->SaveAs(Form("MCFitsWithnfix/MC%iSaltfitresults_upsilon_%s.png",whichUpsilon,kineLabel.Data()));
    c1->SaveAs(Form("MCFitsWithnfix/MC%iSaltfitresults_upsilon_%s.pdf",whichUpsilon,kineLabel.Data()));
  }
  else {
    c1->SaveAs(Form("MCFitsWithnfix/MC%iSnomfitresults_upsilon_%s.png",whichUpsilon,kineLabel.Data()));
    c1->SaveAs(Form("MCFitsWithnfix/MC%iSnomfitresults_upsilon_%s.pdf",whichUpsilon,kineLabel.Data()));
  }
...
TString outFileName;
  if (whichModel){
    outFileName = Form("MCFitsWithnfix/MC%iSaltfitresults_upsilon_%s.root",whichUpsilon,kineLabel.Data());
  }
  else {
    outFileName = Form("MCFitsWithnfix/MC%iSnomfitresults_upsilon_%s.root",whichUpsilon,kineLabel.Data());
  }
