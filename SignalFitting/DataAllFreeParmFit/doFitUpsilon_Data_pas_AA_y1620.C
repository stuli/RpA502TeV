...
void doFitUpsilon_Data_pas_AA_y1620(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar *x1s = new RooRealVar("x1s","sigma ratio ", 0.5, 0.1, 1.91);
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.063 , 1.356, 3.601);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.142 , 2.142, 3.645);
  ...
  RooRealVar *f1s = new RooRealVar("f1s","1S CB fraction", 0.5, 0.425, 0.5912);
