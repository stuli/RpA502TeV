...
void doFitUpsilon_Data_pas_AA_pt912(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar *x1s = new RooRealVar("x1s","sigma ratio ", 0.5, 0, 2.005);
  ...
  RooRealVar n1s_1("n1s_1","power order", 3.405 , 2.002, 3.645);
  ...
  RooRealVar *f1s = new RooRealVar("f1s","1S CB fraction", 0.5, 0.4, 0.6);
