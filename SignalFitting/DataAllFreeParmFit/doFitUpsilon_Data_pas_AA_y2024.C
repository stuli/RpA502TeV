...
void doFitUpsilon_Data_pas_AA_y2024(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar    sigma1s_1("sigma1s_1","width/sigma of the signal gaussian mass DF",0.02, 0.02, 0.1942);
  ...
  RooRealVar *x1s = new RooRealVar("x1s","sigma ratio ", 0.5, 0.1, 2.05);
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.012 , 1.456, 3.621);
  ...
  RooRealVar n1s_1("n1s_1","power order", 3.405 , 2.142, 3.645);
...
//    x1s->setVal(initPset.x1s);
  ...
  RooRealVar *nSig2s= new RooRealVar("nSig2s"," 2S signals", 0,36000);
