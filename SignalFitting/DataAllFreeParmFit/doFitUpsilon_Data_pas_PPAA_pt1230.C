...
void doFitUpsilon_Data_pas_PPAA_pt1230(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar    sigma1s_1("sigma1s_1","width/sigma of the signal gaussian mass PDF",0.05, 0.05, 0.12);
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.022 , 1.396, 3.691);
  ...
  RooRealVar n1s_1("n1s_1","power order", 2.105 , 2.031, 3.701);
