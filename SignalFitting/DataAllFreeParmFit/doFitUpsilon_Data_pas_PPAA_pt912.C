...
void doFitUpsilon_Data_pas_PPAA_pt912(
       int collId = kAADATA,  
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar    sigma1s_1("sigma1s_1","width/sigma of the signal gaussian mass DF",0.05, 0.05, 0.17);
  ...
  RooRealVar *x1s = new RooRealVar("x1s","sigma ratio ", 0.5, 0, 2.0);
  ...
  RooRealVar alpha1s_1("alpha1s_1","tail shift", 2.122 , 1.522, 3.682);
  ...
  RooRealVar n1s_1("n1s_1","power order", 3.505 , 3.301, 3.702);
...
//  drawText(Form("Signal Function : %s CB", SignalCB.Data() ), 0.55,0.54,1,14);
 ...
 // fitleg->Draw("same");
  ...
  pad1->SetLeftMargin(4.2);
  pad2->SetLeftMargin(4.2);
