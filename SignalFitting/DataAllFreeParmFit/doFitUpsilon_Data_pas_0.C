...
void doFitUpsilon_Data_pas_0(
       int collId = kPPDATA,  
       float ptLow=0, float ptHigh=30, 
       float yLow=0, float yHigh=0.8,
       ...
       bool fixParameters=0  )
{
  ...
  RooRealVar err_mu("#mu","err_mu",init_mu,  0, 27) ; // 70-100% up to 30
  RooRealVar err_sigma("#sigma","err_sigma", init_sigma, 0,25); // 0-5%, 20-30%, 60-70%, 70-100% : up to 30
  RooRealVar m_lambda("#lambda","m_lambda",  init_lambda, 0,27); // 0-5%, 20-30%, 60-70%, 70-100% : up to 30
