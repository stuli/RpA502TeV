...
void studyAccAna_new(int Cat_ = 2) { // Cat_ == 0 (1S),  Cat_ == 1 (2S), Cat_ == 2 (3S)
  ...
  if(Cat_==0){
    ...
    fWgtPP->SetParameters(   118.089, -8.40044, 22.7933, -3.55767  );
    fWgtPP_Ap->SetParameters( 163.442, -8.40044, 22.7933, -3.55767  );
    fWgtPP_Bp->SetParameters( 118.089, 1.42371, 22.7933, -3.55767   );
    fWgtPP_Cp->SetParameters( 118.089, -8.40044, 24.9041, -3.55767  );
    fWgtPP_Dp->SetParameters( 118.089, -8.40044, 22.7933, -2.91198  );
    fWgtPP_Am->SetParameters( 72.7371, -8.40044, 22.7933, -3.55767  );
    fWgtPP_Bm->SetParameters( 118.089, -18.2246, 22.7933, -3.55767  );
    fWgtPP_Cm->SetParameters( 118.089, -8.40044, 20.6825, -3.55767  );
    fWgtPP_Dm->SetParameters( 118.089, -8.40044, 22.7933, -4.20335  );
    ...
    fWgtPA->SetParameters(   207.062, -50.5395, 48.9243, -5.38449  );
    fWgtPA_Ap->SetParameters( 277.122, -50.5395, 48.9243, -5.38449  );
    fWgtPA_Bp->SetParameters( 207.062, -11.7056, 48.9243, -5.38449  );
    fWgtPA_Cp->SetParameters( 207.062, -50.5395, 54.5671, -5.38449  );
    fWgtPA_Dp->SetParameters( 207.062, -50.5395, 48.9243, -4.27685  );
    fWgtPA_Am->SetParameters( 137.001, -50.5395, 48.9243, -5.38449  );
    fWgtPA_Bm->SetParameters( 207.062, -89.3733, 48.9243, -5.38449  );
    fWgtPA_Cm->SetParameters( 207.062, -50.5395, 43.2815, -5.38449  );
    fWgtPA_Dm->SetParameters( 207.062, -50.5395, 48.9243, -6.49213  );
  }
  else if(Cat_!=0){
  ...
  if(Cat_ == 0) out = new TFile("acceptance_wgt_1S_20170809.root","RECREATE");
  if(Cat_ == 1) out = new TFile("acceptance_wgt_2S_20170809.root","RECREATE");
  if(Cat_ == 2) out = new TFile("acceptance_wgt_3S_20170809.root","RECREATE");

  // 1 : denominator, 2 : numerator 
  TH1F *hIntAccPPNoW = new TH1F("hIntAccPPNoW",";;",nYBins1,yBin1);
  TH1F *hIntAccPPNoW1 = new TH1F("hIntAccPPNoW1",";;",nYBins1,yBin1);
  TH1F *hIntAccPPNoW2 = new TH1F("hIntAccPPNoW2",";;",nYBins1,yBin1);
  ...
  TH1F *hrapAccPP_Ap1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Bp1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Cp1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Dp1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Am1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Bm1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Cm1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Dm1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Ap2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Bp2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Cp2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Dp2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Am2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Bm2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Cm2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPP_Dm2 = (TH1F*)hrapAccNoW->Clone();
  ...
  TH1F *hrapAccPA_Ap1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Bp1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Cp1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Dp1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Am1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Bm1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Cm1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Dm1 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Ap2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Bp2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Cp2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Dp2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Am2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Bm2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Cm2 = (TH1F*)hrapAccNoW->Clone();
  TH1F *hrapAccPA_Dm2 = (TH1F*)hrapAccNoW->Clone();
  ...
  for(int i = 0; i < nEntries; i++){
    ...
    if( y > -1.46 && y < 2.4 && pt<30.0 ){
      ...
      //denominator for systematics with variations
      hIntAccPA_Ap1->Fill( y-boost, ppwgtAp );
      hIntAccPA_Bp1->Fill( y-boost, ppwgtBp );
      hIntAccPA_Am1->Fill( y-boost, ppwgtAm );
      hIntAccPA_Bm1->Fill( y-boost, ppwgtBm );
  ...
  for(int i = 0; i < hptAccPPNoW2Cp->GetXaxis()->GetNbins(); i++){
    ...
    cout<<"PP 1 : "<<Form("%0.3f",sys1)<<", PP 2 : "<<Form("%0.3f",sys2)<<", PP 3 : "<<Form("%0.3f",sys3)<<", PP 4 : "<<Form("%0.3f",sys4)<<", PP total : "<<Form("%0.3f",sqrt(sys2*sys2+sys1*sys1))<<endl;
    cout<<"PA 1 : "<<Form("%0.3f",sys5)<<", PA 2 : "<<Form("%0.3f",sys6)<<", PA 3 : "<<Form("%0.3f",sys7)<<", PA 4 : "<<Form("%0.3f",sys8)<<", PA total : "<<Form("%0.3f",sqrt(sys2*sys2+sys1*sys1))<<endl;
  }
