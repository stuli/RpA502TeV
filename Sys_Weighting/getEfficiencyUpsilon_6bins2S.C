...
void getEfficiencyUpsilon_6bins2S(int state = 2, bool useDataWeight=false, 
  ...
  TFile* fout = new TFile(Form("%s/efficiency_ups%ds_useDataPtWeight%d_tnp_trgId%d_trkId%d_muId%d_staId%d_6BinsFor2S.root",outputDirName.Data(), state,useDataWeight,trgIdx, trkIdx, muIdx, staIdx),"recreate");

  c_eff_pt->SaveAs(Form("%s/eff_vs_pt_%ds_useDataPtWeight%d_tnp_trgId%d_trkId%d_muId%d_staId%d_6BinsFor2S.root.pdf", outputDirName.Data(), state, useDataWeight, trgIdx, trkIdx, muIdx, staIdx ));
  c_eff_rap->SaveAs(Form("%s/eff_vs_rap_%ds_useDataPtWeight%d_tnp_trgId%d_trkId%d_muId%d_staId%d_6BinsFor2S.root.pdf", outputDirName.Data(), state, useDataWeight, trgIdx, trkIdx, muIdx, staIdx ));
  c_eff_cent->SaveAs(Form("%s/eff_vs_cent_%ds_useDataPtWeight%d_tnp_trgId%d_trkId%d_muId%d_staId%d_6BinsFor2S.root.pdf", outputDirName.Data(), state, useDataWeight, trgIdx, trkIdx, muIdx, staIdx ));
