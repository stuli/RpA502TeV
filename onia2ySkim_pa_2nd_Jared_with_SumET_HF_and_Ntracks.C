...
void onia2ySkim_pa_2nd_Jared_with_SumET_HF_and_Ntracks( int nevt = -1,
		 int fileID = kPADATA,
		 ...
		 ) 
{
  ...
  if (fileID == kPADATA) {
    ...
    fname = "RD2013_pa_2nd_run_merged.root";
    mytree->Add(fname.Data());
  }
  ...
  if (fileID == kPADATA) {
    newfile = new TFile(Form("Jared_yskimPA2nd_%s_%s_%s_with_SumET_HF_and_Ntracks.root",fdimusign.Data(), getDayAndTime().Data(), skimVersion.Data() ),"recreate");   
  }
